...
import (
	...
	"github.com/NA-SyncWare/go-admin/modules/config"
	"github.com/NA-SyncWare/go-admin/modules/language"
	template2 "github.com/NA-SyncWare/go-admin/template"
...
func buildProject(cfgFile string) {
	...
	if defaultLang == "cn" || p.Language == language.CN || p.Language == "cn" {
		...
		fmt.Println("- sqlite: " + ansi.Color("https://github.com/NA-SyncWare/go-admin/raw/master/data/admin.db", "blue"))
		fmt.Println("- mssql: " + ansi.Color("https://raw.githubusercontent.com/NA-SyncWare/go-admin/master/data/admin.mssql", "blue"))
		fmt.Println("- postgresql: " + ansi.Color("https://raw.githubusercontent.com/NA-SyncWare/go-admin/master/data/admin.pgsql", "blue"))
		fmt.Println("- mysql: " + ansi.Color("https://raw.githubusercontent.com/NA-SyncWare/go-admin/master/data/admin.sql", "blue"))
	}
	fmt.Println()
